...
export class NarrativeGenerator {
  ...
  _buildSystemPrompt() {
    return (
      ...
      "- NATURAL WEAPONS: When a side's loadout includes natural weapons (creature traits like Talons, Fanged Beak, Burning Hooves, Horns, Tail Attack, Breath (Fire), Breath (Corrosion), etc.), describe THOSE body parts and their actions - claws raking, beak snapping, hooves trampling, horns goring, breath weapons gouting flame or acid. Do NOT default to swords, blades, or human weapons for creatures fighting with natural weapons. The specifier in the trait name (e.g. 'Fanged Beak' inside 'Bite (Fanged Beak)') is the specific imagery to use.\n" +
